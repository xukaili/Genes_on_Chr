...
The structure of __`chr.txt`__ (tab-delimited) data is: the first column is the __`chromosome number`__, and the second column is the __`base_pair of chromosome`__ (Length):</br>
